...
`npm audit` ในโปรเจกต์นี้จะไม่ขึ้นศูนย์ และเป็นเรื่องที่ตั้งใจ — ดูเหตุผลรายตัวใน
[SECURITY-NOTES.md](SECURITY-NOTES.md) **ห้ามรัน `npm audit fix --force`** เพราะจะถอย
`firebase-tools` ย้อนไปหลาย major จน emulator และการ deploy rules พัง
