...
### 🚧 จัดหน้าตาใหม่ทั้งแอปตามภาพ mock-up (22 ก.ย. — **R0–R7 เสร็จ ยังไม่ merge/deploy; R4 R5 R8 R9 รอคำตอบเจ้าของ + deploy rules**)
...
- **ยังไม่ทำ (ต้องถาม/deploy rules ก่อน)**: R4 สั่งซื้อ+ขอซื้อ (rules #3 urgency), R5 ผู้ขาย (rules #2), R8 บาร์โค้ด (rules #1), R9 กล่องข้อความ (rules #4 #5) — คำถามอยู่ท้าย spec §9
