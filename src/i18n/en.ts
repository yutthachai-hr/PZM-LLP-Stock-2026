...
export const EN: Record<string, string> = {
  ...
  'ยกเลิก {docNo} ? ใบที่ยังไม่รับของเท่านั้นที่ยกเลิกได้': 'Cancel {docNo}? Only orders that have not been received can be cancelled.',
  ...
  'ลบไม่ได้: ใบสั่งซื้อนี้รับของเข้าคลังแล้ว': 'Cannot delete: this order has already reached the books',
  '— ยังไม่ระบุ —': '— not set —',
  ...
  'สร้างใบสั่งซื้อ {n} ใบ ({list}) จากจำนวนที่อนุมัติ — ทำได้ครั้งเดียว': 'Create {n} purchase orders ({list}) from the approved quantities — this can be done once',
  ...
  'ทั้งวัน': 'All day',
  'ตามระยะส่งของผู้ขาย: {date}': 'from the supplier\'s lead time: {date}',
