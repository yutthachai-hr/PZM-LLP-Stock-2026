...
export const EN: Record<string, string> = {
  ...
  'ลบอัตราแปลงหน่วยของสินค้านี้ออกก่อน จึงจะเปลี่ยนหน่วยนับได้': 'Remove this product\'s unit rates before changing its unit',
  'สินค้านี้มีประวัติที่แปลงหน่วยไว้แล้ว เปลี่ยนหน่วยนับไม่ได้ — กรุณาสร้างสินค้าใหม่ด้วยหน่วยที่ถูกต้อง': 'This product has converted history; its unit cannot change — create a new product with the right unit',
