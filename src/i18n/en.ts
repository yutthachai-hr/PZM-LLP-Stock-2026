...
export const EN: Record<string, string> = {
  ...
  'หน่วยที่คุณเลือกกับหน่วยรับเข้าสินค้าไม่ตรงกัน กรุณาตรวจสอบอีกครั้งก่อนกดยืนยัน': 'The unit you chose is not the unit this product is received in — check it again before confirming',
  'มี {n} รายการที่หน่วยไม่ตรงกับหน่วยรับเข้าสินค้า — ตรวจสอบอีกครั้งก่อนกดยืนยัน': '{n} line(s) are in a unit other than the receiving unit — check them again before confirming',
