...
export const EN: Record<string, string> = {
  ...
  'เช่น 1 ลัง = 288 {unit} — ระบบบันทึกสต๊อกเป็น {unit} จริงตามอัตรานี้ทุกครั้งที่คีย์เป็นลัง ประวัติเก่าคงอัตราที่บันทึกไว้ตอนนั้น': 'e.g. 1 case = 288 {unit} — stock is filed in {unit} at this rate whenever a case is keyed. Past rows keep the rate they were filed at.',
